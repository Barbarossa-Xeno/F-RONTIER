...
public class ModalWindow : MonoBehaviour
{
    ...
    private const float maxSpeed = 24.9f;
    private const float minTiming = -2.0f;
    private const float maxTiming = 2.0f;
    ...
    public void SpeedButtonPressed(int buttonIndex){
        void ChangeValue(int buttonIndex){
            switch(buttonIndex){
                ...
                Setting.setting.Save[0].noteSpeed = Setting.setting.Save[0].noteSpeed < minSpeed? minSpeed: Setting.setting.Save[0].noteSpeed;
                Setting.setting.Save[0].noteSpeed = Setting.setting.Save[0].noteSpeed > maxSpeed? maxSpeed: Setting.setting.Save[0].noteSpeed;
                break;
                case 1:
     ...
     public void TimingButtonPressed(int buttonIndex){
        void ChangeValue(int buttonIndex){
            switch(buttonIndex){
                ...
                Setting.setting.Save[0].timing = Setting.setting.Save[0].timing < minTiming? minTiming: Setting.setting.Save[0].timing;
                Setting.setting.Save[0].timing = Setting.setting.Save[0].timing > maxTiming? maxTiming: Setting.setting.Save[0].timing;
                break;
                case 1:
