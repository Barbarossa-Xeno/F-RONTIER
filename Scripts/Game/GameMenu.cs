...
namespace FRONTIER.Game
{
    public class GameMenu : MonoBehaviour
    {
        ...
        void Start()
        {
            switch (GameManager.instance.info.DifficultyTo(GameManager.instance.info.Difficulty).Item1)
            {
                case Reference.DifficultyUtilities.LITE:
        ...
        public void Retire()
        {
            SceneNavigator.instance.ChangeScene("Menu", 1f, ignoreTimeScale: true);
