...
namespace FRONTIER.Game
{
    ...
    public class JudgementEffectPool : MonoBehaviour
    {
        ...
        void Awake()
        {
            perfect = new ObjectPool<GameObject>(() => Create(prefabs.perfect),
            ...
            great = new ObjectPool<GameObject>(() => Create(prefabs.great),
                                               target => target.SetActive(true),
                                               target => target.SetActive(false),
                                               target => Destroy(target),
                                               false,
            ...
            good = new ObjectPool<GameObject>(() => Create(prefabs.good),
                                              target => target.SetActive(true),
                                              target => target.SetActive(false),
                                              target => Destroy(target),
                                              false,
            ...
            bad = new ObjectPool<GameObject>(() => Create(prefabs.bad),
                                             target => target.SetActive(true),
                                             target => target.SetActive(false),
                                             target => Destroy(target),
                                             false,
            ...
            miss = new ObjectPool<GameObject>(() => Create(prefabs.miss),
                                              target => target.SetActive(true),
                                              target => target.SetActive(false),
                                              target => Destroy(target),
                                              false,
